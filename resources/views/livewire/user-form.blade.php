  ...
  <div class="form-group row">
    ...
    <div class="col-md-9">
      <input class="form-control" wire:model="name" id="name" type="text" name="name" value="{{ old('name') }}" placeholder="name of the user">
  ...
  <div class="form-group row">
    ...
    <div class="col-md-9">
      <input class="form-control" wire:model="email" id="email" type="email" name="email" value="{{ old('email') }}" placeholder="something@example.com" autocomplete="email">
