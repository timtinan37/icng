<form class="form-horizontal" action="{{ route('cover-notes.store') }}" method="post">
  ...
  <div class="form-group row">
    ...
    <div class="col-md-9 col-form-label">
      @foreach($risks as $risk)
        <div class="form-check form-check-inline mr-1">
          <input class="form-check-input" id="{{ $risk->id }}" name="risk{{ $risk->id }}" type="checkbox" value="{{ $risk->id }}">
  ...
  <div class="form-group row">
    ...
    <div class="col-md-9">
      <input class="form-control" id="period_starts" type="date" name="period_starts">
  ...
  <div class="form-group row">
    ...
    <div class="col-md-9">
      <input class="form-control" id="period_ends" type="date" name="period_ends">
